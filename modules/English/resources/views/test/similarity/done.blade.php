...
@section('content')
    ...
    <form action="{{route('test.similarity.done')}}?page={{$page}}" method="POST" id="formTest">
        {{csrf_field()}}
        @foreach($questions as $k => $question)
            ...
            <div class="form-group speakEnglish">{!! \ViewFa::underline($question->replacement, $question->question) !!}</div>
            <table class="table">
