...
<form class="form-group row" id="formFilter" action="{{route('verify-users.index')}}" method="POST">
    ...
    <div class="col-sm-1 form-group">
        ...
        <a class="btn btn-primary btn-block" href="{{route('verify-users.create')}}"><i class="fa fa-plus"></i></a>
    </div>
</form>
<div  id="table">
    @include('acl::verify-user.table')
</div>
@endsection
