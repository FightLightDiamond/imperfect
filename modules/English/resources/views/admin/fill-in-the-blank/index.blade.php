...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('admin.fill-in-the-blanks.index')}}" method="POST">
        ...
        <div class="col-sm-1 form-group">
            ...
            <a class="btn btn-primary btn-block" href="{{route('admin.fill-in-the-blanks.create')}}"><i class="fa fa-plus"></i></a>
        </div>
    </form>
    <div class="form-group" id="table">
        @include('en::admin.fill-in-the-blank.table')
    </div>
@endsection
