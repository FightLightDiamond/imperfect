...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('lesson-sub-comment.index')}}" method="POST">
        ...
        <!--</div>-->
        <div class="col-sm-2 form-group">
            <a class="btn btn-primary" href="{{route('lesson-sub-comment.create')}}"><i class="fa fa-plus"></i></a>
            <!--<a class="btn btn-danger"><i class="fa fa-trash"></i></a>-->
        </div>
    </form>
    <div class="form-group" id="table">
        @include('tut::lesson-sub-comment.table')
    </div>
@endsection
