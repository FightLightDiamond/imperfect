    ...
    <div class="row">
        ...
        <form action="{{route('tutorial.update', $tutorial->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group col-lg-12">
                ...
                <input  class="form-control" name="name" id="name" value="{{$tutorial->name}}">
            </div>
            <div class="form-group col-lg-12">
                <label for="description">{{trans('label.description')}}</label>
                <textarea class="form-control" name="description" id="" cols="30"
                          rows="10">{!! $tutorial->description !!}</textarea>
            </div>
            ...
            <div class="fileinput fileinput-new form-group col-lg-6 " data-provides="fileinput">
                <div class="fileinput-new thumbnail" data-trigger="fileinput">
                    <img class="img-responsive"
                         src="{{$tutorial->img ? asset('storage') .$tutorial->img : 'http://placehold.it/200x150'}}"
                         alt="...">
                </div>
            ...
            <div class="form-group col-lg-12">
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" {{$tutorial->is_active !== 1 ?: 'checked'}} name="is_active"
