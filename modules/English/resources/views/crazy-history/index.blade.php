...
<form class="form-group row" id="formFilter" action="{{route('admin.crazies.history.index')}}" method="POST">
    ...
    <div class="col-sm-1 form-group">
        ...
        <a class="btn btn-primary btn-block" href="{{route('admin.crazies.history.create')}}"><i class="fa fa-plus"></i></a>
    </div>
</form>
<div class="form-group" id="table">
    @include('en::admin.crazy-history.table')
</div>
@endsection
