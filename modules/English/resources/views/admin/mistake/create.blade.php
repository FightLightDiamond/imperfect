...
@section('content')
    ...
    <div class="row">
        <form action="{{route('admin.mistakes.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-group col-lg-12">
                <label for="question">{{trans('label.question')}}</label>
                <input class="form-control englishInput" name="question" id="question" required>
            </div>
            ...
            <div class="form-group col-lg-12">
                ...
                <input class="form-control englishInput" name="repair" id="repair">
            </div>
            <div class="form-group col-lg-12">
