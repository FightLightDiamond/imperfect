...
<form class="form-group row" id="formFilter" action="{{route('crazy-write-histories.index')}}" method="POST">
    ...
    <div class="col-sm-1 form-group">
        ...
        <a class="btn btn-primary btn-block" href="{{route('crazy-write-histories.create')}}"><i class="fa fa-plus"></i></a>
    </div>
</form>
<div  id="table">
    @include('en::admin.crazy-write-history.table')
</div>
@endsection
