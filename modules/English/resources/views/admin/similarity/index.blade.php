...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('admin.similarities.index')}}" method="POST">
        ...
        <div class="col-sm-1 form-group">
            ...
            <a class="btn btn-primary btn-block" href="{{route('admin.similarities.create')}}"><i class="fa fa-plus"></i></a>
        </div>
    </form>
    <div class="form-group" id="table">
        @include('en::admin.similarity.table')
    </div>
@endsection
