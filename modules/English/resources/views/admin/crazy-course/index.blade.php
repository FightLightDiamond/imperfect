...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('admin.crazy-courses.index')}}" method="POST">
        ...
        <div class="col-sm-1 form-group">
            ...
            <a class="btn btn-primary btn-block" href="{{route('admin.crazy-courses.create')}}"><i class="fa fa-plus"></i></a>
        </div>
    </form>
    <div class="form-group" id="table">
        @include('en::admin.crazy-course.table')
    </div>
@endsection
