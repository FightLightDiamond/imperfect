...
@section('content')
    ...
    <div class="row">
        <form action="{{route('admin.similarities.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group col-lg-12">
                ...
                <input  class="form-control englishInput" required name="replacement" id="replacement">
            </div>
            <div class="form-group col-lg-12">
