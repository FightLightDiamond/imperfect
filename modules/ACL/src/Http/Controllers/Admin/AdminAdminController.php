...
use ACL\Http\Requests\Admin\AdminCreateRequest;
use ACL\Http\Requests\Admin\AdminUpdateRequest;
use ACL\Http\Resources\Admin\AdminResource;
use ACL\Http\Resources\Admin\AdminResourceCollection;
use ACL\Http\Services\Admin\AdminService;
...
class AdminAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
           ...
           return new AdminResourceCollection($data);
    ...
    public function store(AdminCreateRequest $request)
    {
        try {
            $input = $request->all();
            $admin = $this->service->store($input);
