...
@section('content')
    ...
    <form class="form-group row" id="formFilter" action="{{route('lesson-comment.index')}}" method="POST">
        ...
        <!--</div>-->
        <div class="col-sm-2 form-group">
            <a class="btn btn-primary" href="{{route('lesson-comment.create')}}"><i class="fa fa-plus"></i></a>
